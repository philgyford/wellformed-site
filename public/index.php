<?php
$HEAD_TITLE = "Well-Formed";
$NAV_ACTIVE = "home";
include "includes/page_start.php";
?>

<div class="bodytext">
	<p>Well-Formed is a tiny company in the UK making interesting, small websites. We are open to many kinds of projects&nbsp;including:</p>
	<ul>
		<li>
		...
		If you’ve got a lot of data that could be more visible and usable, we can get it online in a simple, clear website that's easy to explore and&nbsp;share. See the <a href="/projects/#spelunker">MoMA Exhibition Spelunker</a>.</p>
		</li>
		<?php /*
		<li>
			<p><strong>Building prototypes</strong><br />
			Whether you call it a prototype, an Alpha, R&amp;D, or something else, we can help you get a first-version of your website or service up and&nbsp;running.</p>
		</li>
		*/ ?>
		<li>
			<p><strong>Archiving or resurrecting old websites</strong><br />
			Our decades of experience have helped us create static archivable versions of websites for <abbr title="The Museum of Modern Art, New York">MoMA</abbr>, and carefully update sites whose technology hasn’t been updated for many years.</p>
		</li>
	</ul>

	<p>We like websites that are simple and fast, that are built around usability and data, and that do good things on, for and with the web.</p>

	<p>We prefer trusted technology over the latest fads, but are keen to try new things when it makes the result better for users.</p>

	<p>If you have an interesting project we could help with, <a href="mailto:contact@well-formed.co.uk">do&nbsp;get&nbsp;in&nbsp;touch</a>.</p>

	<hr />

	<p>We have previously worked with organizations such as…</p>
	...
	<ul class="list--unstyled grid grid--5 grid--logos">
		...
		<li>
			<a href="https://www.moma.org" title="MoMA (The Museum of Modern Art, New York)"><img class="company-logo img--fluid" src="/assets/img/logos/moma.png" alt="MoMA logo" width="200" height="51"></a>
		</li>
		<li>
			<a href="https://www.artangel.org.uk" title="Artangel"><img class="company-logo img--fluid" src="/assets/img/logos/artangel.png" alt="Artangel logo" width="200" height="54"></a>
		</li>
		<li>
...
?>
	...
	<p><a href="/projects/">Read more about a few of our projects.</a></p>
	<!--
